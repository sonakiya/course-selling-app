...
function AdminLogi() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {   
      ...
      localStorage.setItem("admin",JSON.stringify(response.data))//login krne pr jo token generate hoga usko local storage m save kro or handle logout fxn me isko receive krege Home.jsx m
  ...
  return (
    <div className="bg-gradient-to-r from-black to-blue-950 ">
      <div className="h-screen container mx-auto flex  items-center justify-center text-white">
        ...
        {/* Login Form */}
        <div className="bg-gray-900 p-8 rounded-lg shadow-lg w-[500px] m-10 md:m-0 mt-20">
          <h2 className="text-2xl font-bold mb-4 text-center">
            Welcome to <span className="text-orange-500">AyuVersity</span>
          </h2>
